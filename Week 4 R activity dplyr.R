...
select_columns <- select(Haoting_dataset,weight,Time)
...
two_columns_dataset <- select_columns
...
average_weight <- summarize(grouped_data, avg_weight = mean(ounces))
